...
- ユーザー目線の便利さ`;
  ...
  const systemPrompt = "あなたはSNS運用のプロです。エンゲージメントが高く、自然体で共感を得やすい投稿を作成します。投稿文のみを出力してください。";
